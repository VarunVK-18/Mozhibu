import { Component, AfterViewInit, Input, Inject, PLATFORM_ID, ChangeDetectionStrategy } from '@angular/core';
...
@Component({
  ...
  styles: [`
    ...
    .ad-fallback-text span { font-weight: 600; text-transform: uppercase; letter-spacing: 1px; }
    .ad-fallback-text small { font-size: 11px; margin-top: 4px; }
  `]
})
