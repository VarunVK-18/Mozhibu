    ...
    <div class="page-layout">
      ...
      <div class="featured-post wrap">
        <div class="featured-image">
          <img src="https://placehold.co/800x500/3F6259/FFFFFF?text=Writing+Contest" alt="Featured">
        </div>
        <div class="featured-content">
          <span class="tag">Announcements</span>
          <h2>The 2026 Mozhibu Summer Writing Contest</h2>
          <p>Join our biggest writing competition of the year. Over $50,000 in prizes, exclusive publishing contracts, and a chance to have your story featured on the front page.</p>
          <div class="meta">
            <img src="assets/logo.png" alt="Mozhibu Team" class="author-avatar">
            <div>
  ...
  posts = [
    {
      ...
      excerpt: 'Master the art of the cliffhanger and keep your readers coming back week after week.',
      date: 'Aug 15, 2026'
    },
    {
      ...
      excerpt: 'How one indie author went from 0 to 10,000 subscribers in her first three months on the platform.',
      date: 'Aug 12, 2026'
    },
    {
      ...
      excerpt: 'We have completely revamped the author dashboard to give you deeper insights into reader retention.',
      date: 'Aug 05, 2026'
    },
    {
      ...
      excerpt: 'Exploring the massive surge in popularity of game-mechanic fiction and why readers love it.',
      date: 'Jul 28, 2026'
    },
    {
      ...
      excerpt: 'You do not have to lock everything behind a paywall. Here are alternative ways to earn as a writer.',
      date: 'Jul 20, 2026'
    },
    {
      ...
      excerpt: 'You can now queue up your chapters months in advance. Learn how to use the new calendar tool.',
      date: 'Jul 15, 2026'
    }
  ];
}
