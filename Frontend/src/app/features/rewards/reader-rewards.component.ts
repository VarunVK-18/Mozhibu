        ...
        @if (isLoading()) {
          ...
          @if (currentScore()) {
            <div class="score-card">
              ...
              <div class="total-score">
                {{ currentScore().totalScore }}<span class="pts"> pts</span>
              </div>
              <div class="score-breakdown">
                <div class="score-row">
                  ...
                  <div class="score-bar">
                    <div
                      class="bar-fill"
                      [style.width]="currentScore().readingScore + '%'"
                    ></div>
                  </div>
                ...
                <div class="score-row">
                  ...
                  <div class="score-bar">
                    <div
                      ...
                      [style.width]="currentScore().timeScore + '%'"
                    ></div>
                  </div>
                ...
                <div class="score-row">
                  ...
                  <div class="score-bar">
                    <div
                      ...
                      [style.width]="currentScore().interactionScore + '%'"
                    ></div>
                  </div>
          ...
          <div class="table-section">
            ...
            @if (rewards().length === 0) {
              <div class="empty-state">
                ...
                <p>
                  No rewards yet. Keep reading to build your engagement score!
                </p>
              </div>
            } @else {
          ...
          <div class="how-it-works">
            ...
            <div class="formula-card">
              <code
                >Your Reward = (Your Engagement Score ÷ Total Platform Score) ×
                Readers Pool</code
              >
            </div>
            <p>
              The Readers Pool is <strong>5%</strong> of monthly net ad revenue.
              Score more by reading consistently, completing chapters, and
