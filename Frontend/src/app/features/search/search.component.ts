...
@Component({
  ...
  styles: [`
    ...
    @media (max-width: 900px) {
      ...
      .tabs { gap: 16px; overflow-x: auto; width: 100%; -webkit-overflow-scrolling: touch; padding-bottom: 4px; }
      .tabs-and-sort { flex-direction: column; align-items: flex-start; gap: 16px; width: 100%; min-width: 0; }
      .sort-dropdown { padding-bottom: 0; margin-bottom: 16px; width: 100%; }
      .sort-dropdown .filter-select { flex: 1; }
    }
    
    @media (max-width: 640px) {
      .search-sidebar { padding: 16px; gap: 20px; }
      .search-header { padding: 16px 16px 0; }
      .search-results { padding: 16px; }
      
      .search-bar { padding: 4px 4px 4px 16px; margin-bottom: 16px; width: 100%; }
      .search-bar input { font-size: 14px; padding: 10px 8px; width: 100%; min-width: 0; }
      .btn-primary { padding: 10px 16px; font-size: 13px; flex-shrink: 0; }
      
      .tabs { gap: 24px; padding-bottom: 8px; width: 100%; }
      .tab-btn { white-space: nowrap; font-size: 14px; padding-bottom: 8px; }
      ...
      .genre-badge { font-size: 10px; padding: 2px 4px; }
      
      .author-card { padding: 16px; }
      .author-avatar { width: 60px; height: 60px; margin-bottom: 12px; }
      .author-name { font-size: 14px; }
      .author-followers { font-size: 12px; }
    }
  `]
})
