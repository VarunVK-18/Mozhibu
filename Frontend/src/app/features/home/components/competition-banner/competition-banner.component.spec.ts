...
describe('CompetitionBannerComponent', () => {
  ...
  beforeEach(async () => {
    mockCompetitionService = jasmine.createSpyObj('CompetitionService', ['getActiveCompetition']);

    await TestBed.configureTestingModule({
      imports: [CompetitionBannerComponent, TranslatePipe, HttpClientTestingModule],
      providers: [
