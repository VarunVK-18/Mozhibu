      ...
      <div class="hero-content">
        ...
        <h1 class="title">
          ...
          @if (accessType === 'premium') {
            <span class="premium-text" style="display:inline-flex; align-items:center; gap:6px; color:#FFD700; font-size:16px; border:1px solid #FFD700; padding:2px 8px; border-radius:4px; vertical-align:middle; margin-left:12px;">
