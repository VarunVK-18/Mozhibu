                ...
                <div class="form-group">
                  ...
                  <div class="cover-upload-container">
                    ...
                    @if (coverPreviewUrl() || story.cover) {
                      <button (click)="removeCover()" class="btn-text-error">
                        Remove Cover
                      </button>
                    }
                  </div>
                ...
                <div class="form-row">
                  <div class="form-group">
                    ...
                    <input
                      ...
                      [(ngModel)]="story.tags"
                      class="input-field"
                      placeholder="e.g. cyberpunk, action"
                    />
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input
                      ...
                      class="input-field"
                      placeholder="Is this part of a series?"
                    />
                  </div>
                </div>
              ...
              <div class="cropper-modal-overlay">
                <div class="cropper-modal">
                  ...
                  <div class="cropper-actions">
                    <button class="btn-outline" (click)="cancelCrop()">
                      Cancel
                    </button>
    ...
    this.bookService.updateBook(this.bookId!, bookData).subscribe({
      next: (updatedBook: any) => {
        ...
        if (updatedBook?.cover) {
          const serverUrl = environment.apiUrl.replace('/api', '');
          const coverUrl =
            updatedBook.cover.startsWith('http') ||
            updatedBook.cover.startsWith('data:')
              ? updatedBook.cover
      ...
      error: (err) => {
        ...
        this.errorMessage =
          'Failed to update story settings. Please try again.';
        this.isSaving = false;
      },
    });
  }
